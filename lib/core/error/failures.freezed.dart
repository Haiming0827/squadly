...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( ServerFailure value)?  server,TResult Function( NetworkFailure value)?  network,TResult Function( UnauthorizedFailure value)?  unauthorized,TResult Function( NotFoundFailure value)?  notFound,TResult Function( SquadFullFailure value)?  squadFull,TResult Function( SquadMinMembersFailure value)?  squadMinMembers,TResult Function( PermissionDeniedFailure value)?  permissionDenied,TResult Function( ValidationFailure value)?  validation,TResult Function( UnknownFailure value)?  unknown,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return notFound(_that);case SquadFullFailure() when squadFull != null:
return squadFull(_that);case SquadMinMembersFailure() when squadMinMembers != null:
return squadMinMembers(_that);case PermissionDeniedFailure() when permissionDenied != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( ServerFailure value)  server,required TResult Function( NetworkFailure value)  network,required TResult Function( UnauthorizedFailure value)  unauthorized,required TResult Function( NotFoundFailure value)  notFound,required TResult Function( SquadFullFailure value)  squadFull,required TResult Function( SquadMinMembersFailure value)  squadMinMembers,required TResult Function( PermissionDeniedFailure value)  permissionDenied,required TResult Function( ValidationFailure value)  validation,required TResult Function( UnknownFailure value)  unknown,}){
final _that = this;
switch (_that) {
case ServerFailure():
...
return notFound(_that);case SquadFullFailure():
return squadFull(_that);case SquadMinMembersFailure():
return squadMinMembers(_that);case PermissionDeniedFailure():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( ServerFailure value)?  server,TResult? Function( NetworkFailure value)?  network,TResult? Function( UnauthorizedFailure value)?  unauthorized,TResult? Function( NotFoundFailure value)?  notFound,TResult? Function( SquadFullFailure value)?  squadFull,TResult? Function( SquadMinMembersFailure value)?  squadMinMembers,TResult? Function( PermissionDeniedFailure value)?  permissionDenied,TResult? Function( ValidationFailure value)?  validation,TResult? Function( UnknownFailure value)?  unknown,}){
final _that = this;
switch (_that) {
case ServerFailure() when server != null:
return server(_that);case NetworkFailure() when network != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String message)?  server,TResult Function( String? message)?  network,TResult Function( String? message)?  unauthorized,TResult Function( String? message)?  notFound,TResult Function()?  squadFull,TResult Function()?  squadMinMembers,TResult Function( String? message)?  permissionDenied,TResult Function( String message)?  validation,TResult Function( String? message)?  unknown,required TResult orElse(),}) {final _that = this;
switch (_that) {
case ServerFailure() when server != null:
...
return notFound(_that.message);case SquadFullFailure() when squadFull != null:
return squadFull();case SquadMinMembersFailure() when squadMinMembers != null:
return squadMinMembers();case PermissionDeniedFailure() when permissionDenied != null:
return permissionDenied(_that.message);case ValidationFailure() when validation != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String message)  server,required TResult Function( String? message)  network,required TResult Function( String? message)  unauthorized,required TResult Function( String? message)  notFound,required TResult Function()  squadFull,required TResult Function()  squadMinMembers,required TResult Function( String? message)  permissionDenied,required TResult Function( String message)  validation,required TResult Function( String? message)  unknown,}) {final _that = this;
switch (_that) {
case ServerFailure():
...
return notFound(_that.message);case SquadFullFailure():
return squadFull();case SquadMinMembersFailure():
return squadMinMembers();case PermissionDeniedFailure():
return permissionDenied(_that.message);case ValidationFailure():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String message)?  server,TResult? Function( String? message)?  network,TResult? Function( String? message)?  unauthorized,TResult? Function( String? message)?  notFound,TResult? Function()?  squadFull,TResult? Function()?  squadMinMembers,TResult? Function( String? message)?  permissionDenied,TResult? Function( String message)?  validation,TResult? Function( String? message)?  unknown,}) {final _that = this;
switch (_that) {
case ServerFailure() when server != null:
return server(_that.message);case NetworkFailure() when network != null:
return network(_that.message);case UnauthorizedFailure() when unauthorized != null:
...
class SquadFullFailure implements Failure {
  const SquadFullFailure();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SquadFullFailure);
}
...
class SquadMinMembersFailure implements Failure {
  const SquadMinMembersFailure();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SquadMinMembersFailure);
}
...
@override
String toString() {
  return 'Failure.squadMinMembers()';
}
